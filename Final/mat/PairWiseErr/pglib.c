...
#include<stdio.h>                                
void pg_pdelay_17_np10(int indata, int* outdata){
...
#include<stdio.h>                                
void pg_pdelay_17_np17(int indata, int* outdata){
  *outdata = 0x1FFFF&indata;      
  return;                                        
}          
/* Generated by PGPG module generateor       */
...
{                                                                   
  ...
  for(i=0;i<n;i++){                                               
    ...
    xi = ((unsigned int) ((x[i][0] + ((6.0)/2.0)) * (pow(2.0,(double)32)/(6.0)) + 0.5)) & 0xffffffff;
    yi = ((unsigned int) ((x[i][1] + ((6.0)/2.0)) * (pow(2.0,(double)32)/(6.0)) + 0.5)) & 0xffffffff;
    zi = ((unsigned int) ((x[i][2] + ((6.0)/2.0)) * (pow(2.0,(double)32)/(6.0)) + 0.5)) & 0xffffffff;
    if(eps2 == 0.0){                                         
      ieps2 = 0;                                                
    }else if(eps2 > 0.0){                                    
      ieps2 = (((int)(pow(2.0,8.0)*log(eps2*((pow(2.0,(double)32)/(6.0))*(pow(2.0,(double)32)/(6.0))))/log(2.0))) & 0x7fff) | 0x8000;
    }else{                                                 
      ieps2 = (((int)(pow(2.0,8.0)*log(-eps2*((pow(2.0,(double)32)/(6.0))*(pow(2.0,(double)32)/(6.0))))/log(2.0))) & 0x7fff) | 0x18000;
    }                                                      
    sx = 0;
    sy = 0;
    sz = 0;
    ...
    for(j=0;j<n;j++){                                             
      ...
      xj = ((unsigned int) ((x[j][0] + ((6.0)/2.0)) * (pow(2.0,(double)32)/(6.0)) + 0.5)) & 0xffffffff;
      yj = ((unsigned int) ((x[j][1] + ((6.0)/2.0)) * (pow(2.0,(double)32)/(6.0)) + 0.5)) & 0xffffffff;
      zj = ((unsigned int) ((x[j][2] + ((6.0)/2.0)) * (pow(2.0,(double)32)/(6.0)) + 0.5)) & 0xffffffff;
      if(m[j] == 0.0){                                         
        mj = 0;                                                
      }else if(m[j] > 0.0){                                    
        mj = (((int)(pow(2.0,8.0)*log(m[j]*(pow(2.0,95.38)/(1.0)))/log(2.0))) & 0x7fff) | 0x8000;
      }else{                                                 
        mj = (((int)(pow(2.0,8.0)*log(-m[j]*(pow(2.0,95.38)/(1.0)))/log(2.0))) & 0x7fff) | 0x18000;
      }                                                      
      ...
      pg_pdelay_17_np10(dx,&dxr);
      pg_pdelay_17_np10(dy,&dyr);
      pg_pdelay_17_np10(dz,&dzr);
      pg_log_shift_log17_1(dx,&x2);
      pg_log_shift_log17_1(dy,&y2);
      pg_log_shift_log17_1(dz,&z2);
      pg_pdelay_17_np8(ieps2,&ieps2r);
    ...
    a[i][0] = ((double)(sx<<0))*(-(pow(2.0,(double)32)/(6.0))*(pow(2.0,(double)32)/(6.0))*(pow(2.0,23.0))/(pow(2.0,95.38)/(1.0)))/pow(2.0,0.0);
    a[i][1] = ((double)(sy<<0))*(-(pow(2.0,(double)32)/(6.0))*(pow(2.0,(double)32)/(6.0))*(pow(2.0,23.0))/(pow(2.0,95.38)/(1.0)))/pow(2.0,0.0);
    a[i][2] = ((double)(sz<<0))*(-(pow(2.0,(double)32)/(6.0))*(pow(2.0,(double)32)/(6.0))*(pow(2.0,23.0))/(pow(2.0,95.38)/(1.0)))/pow(2.0,0.0);
