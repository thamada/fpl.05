...
{                                                                   
  ...
  for(i=0;i<n;i++){                                               
    ...
    xi = ((unsigned int) ((x[i][0] + ((100.0)/2.0)) * (pow(2.0,(double)32)/(100.0)) + 0.5)) & 0xffffffff;
    yi = ((unsigned int) ((x[i][1] + ((100.0)/2.0)) * (pow(2.0,(double)32)/(100.0)) + 0.5)) & 0xffffffff;
    zi = ((unsigned int) ((x[i][2] + ((100.0)/2.0)) * (pow(2.0,(double)32)/(100.0)) + 0.5)) & 0xffffffff;
    if(eps2 == 0.0){                                         
      ieps2 = 0;                                                
    }else if(eps2 > 0.0){                                    
