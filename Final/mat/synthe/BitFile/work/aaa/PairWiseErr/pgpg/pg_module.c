...
#include<stdio.h>                                
void pg_pdelay_17_np4(int indata, int* outdata){
...
#include<stdio.h>                                
void pg_pdelay_17_np2(int indata, int* outdata){
  *outdata = 0x1FFFF&indata;      
  return;                                        
}          
/* Generated by PGPG module generateor       */
...
#include<stdio.h>                                                  
#include<math.h>                                                   
static long double log_tab_plus_func(long double x)
{                                           
  long double f;                            
...
static void calc_chebyshev_coefficient(
  long double xk_min,               
  long double xk_max,               
  long double* coef0,               
  long double* coef1)               
...
void pg_log_unsigned_add_itp_log17_man8_cut6(int logimage_x, int logimage_y, int* logimage_z){
  int signz=0;  /* 1-bit */                                        
  int x1=0;     /* 17-bit */                  
  int y1=0;     /* 17-bit */                  
  ...
  /* ===========================
     ROM C0 input = 6 bits                  
     ROM C1 input = 6 bits                  
     ROM C0 output = 10 bits                 
     ROM C1 output = 9 bits                 
     BIT EXTENSION = 2 bits                          
     =========================== */
  /* ===========================
     table input  = 12 bits                   
     table output = 9 bits                  
